unit Horse.Provider.FPC.MicroHTTPApplication;
...
type
  ...
  private
    ...
    class var FHTTPApplication: TCustomMicroHTTPApplication;
    class function GetDefaulTCustomMicroHTTPApplication: TCustomMicroHTTPApplication;
...
class function THorseProvider.GetDefaulTCustomMicroHTTPApplication: TCustomMicroHTTPApplication;
begin
  if HTTPApplicationIsNil then
    FHTTPApplication := TCustomMicroHTTPApplication.Create(nil);
...
var
  LHTTPApplication: TCustomMicroHTTPApplication;
begin
  inherited;
  if FPort <= 0 then
  ...
  if FListenQueue = 0 then
    FListenQueue := 15;
  LHTTPApplication := GetDefaulTCustomMicroHTTPApplication;
